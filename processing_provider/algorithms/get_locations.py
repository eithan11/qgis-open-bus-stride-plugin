...
class GetLocations(QgsProcessingAlgorithm):
    ...
    FIELD_DEFINITIONS = [
        ...
        ('snapshot_str', QVariant.String),
        ('route_id', QVariant.Int),
        ('line_ref', QVariant.Int),
        ('operator_ref', QVariant.Int),
        ('ride_id', QVariant.LongLong),
    ...
    KEY_MAP = {
        ...
        'siri_snapshot__snapshot_id': 'snapshot_str',
        'siri_route__id': 'route_id',
